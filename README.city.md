...
<details>
  ...
  - «Квартирник: Разработка приложений 3D-визуализации», Павел Остроухов (CenteraSoft)
  - «Квартирник: Опыт внедрения кроссплатформенной разработки на Xamarin», Роман Барнаев (Zennex)
  - «Квартирник: Разработка приложений 3D-визуализации», Семён Лащёнов (Аналитик Rubius)
</details>
