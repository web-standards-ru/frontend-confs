...
31 марта, Москва  
*Регистрация закрыта, трансляция будет [здесь](http://moscowjs.ru/events/moscowjs-29.html) с 19:30*
...
### [Yaroslavl Frontend Meetup #12](https://yarfrontend.timepad.ru/event/311687/)

1 апреля, Ярославль

Доклады:

- «Декомпозиция и наследование компонентов в React», Алексей Гуськов (Ареал)
- «Отладка nodejs-приложений», Елифантьев Олег
- «Отладка (nodejs-приложений) на продакшене», Владимир Лусс
